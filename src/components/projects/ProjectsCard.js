...
const ProjectsCard = ({ src, link }) => {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="group relative w-full rounded-2xl overflow-hidden bg-[var(--bg-primary)] border border-[var(--border-color,#e5e7eb)] hover:bg-gradient-to-r from-gray-700 to-gray-900 shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-500 cursor-pointer"
    >
      {/* Project Image */}
      <div className="relative aspect-[16/9] overflow-hidden">
        <img
        ...
        {/* Buttons Overlay */}
        <div className="absolute inset-0 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-all duration-500">
          <span className="flex items-center gap-2 bg-gradient-to-r from-gray-700 to-gray-900 text-white font-medium px-5 py-2.5 rounded-lg shadow-md transition-all duration-300">
            <FaExternalLinkAlt className="text-sm" />
            Visit
          </span>
        </div>
